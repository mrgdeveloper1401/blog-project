    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_category', models.CharField(blank=True, choices=[('pb', 'انتشار یافته'), ('rj', 'رد شده')], max_length=2, null=True, verbose_name='وضعیت انشتار')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='sub_category', to='categories.categorymodel')),
            ],
            options={
